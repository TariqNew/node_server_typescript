...
import type { Book } from "../model/model.js";
...
export function GetAllBooks(res: ServerResponse) {
...
export async function handleCreateBook(
  ...
  try {
    ...
    const bookData = body as Partial<Book>;
...
export function GetBookById(res: ServerResponse, id: number) {
